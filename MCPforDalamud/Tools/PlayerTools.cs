...
public static class PlayerTools
{
    public static void Register(ToolRegistry registry)
    {
        ...
        registry.Register(new ToolDefinition { Name = "get_job_gauge", Description = "获取当前职业量谱数据", Handler = _ => { EnsureReady(); var lp = Service.ObjectTable.LocalPlayer!; var jobId = lp.ClassJob.Value.RowId; return new { jobId, note = "职业量谱数据" }; } });
    }
